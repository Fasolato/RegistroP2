...
{
    label=new QLabel("Benvenuto "+user_ata->getNomeutente(),this);
    ...
    text_Nome=new QLabel(user_ata->getNome(),this);
    cognome=new QLabel("Cognome: ",this);
    text_Cognome=new QLabel(user_ata->getCognome(),this);
    lunedi=new QLabel("lunedi: ",this);
    text_Lun=new QLabel(QString::number(user_ata->getOre()[0]),this);
    martedi=new QLabel("martedi: ",this);
    text_Mar=new QLabel(QString::number(user_ata->getOre()[1]),this);
    mercoledi=new QLabel("mercoledi: ",this);
    text_Mer=new QLabel(QString::number(user_ata->getOre()[2]),this);
    giovedi=new QLabel("giovedi: ",this);
    text_Gio=new QLabel(QString::number(user_ata->getOre()[3]),this);
    venerdi=new QLabel("venerdi: ",this);
    text_Ven=new QLabel(QString::number(user_ata->getOre()[4]),this);
    sabato=new QLabel("sabato: ",this);
    text_Sab=new QLabel(QString::number(user_ata->getOre()[5]),this);
    username=new QLabel("Username: ",this);
    text_User=new QLabel(user_ata->getNomeutente(),this);
    password=new QLabel("Password: ",this);
    text_Pass=new QLabel(user_ata->getPassword(),this);
    scuola=new QLabel("Scuola di appartenenza: ",this);
    text_Scuola=new QLabel(user_ata->getScuola().getNome(),this);
    p_mq=new QLabel("Paga al metro quadrato: ",this);
    text_P_Mq=new QLabel(QString::number(user_ata->getPagaM()),this);
    stipendio=new QLabel("Stipendio mensile percepito: : ",this);
    text_Stip=new QLabel(QString::number(user_ata->stipendio()),this);

    plesso pl=user_ata->getScuola();
    ...
    layout2=new QGridLayout();
        ...
        layout1->setRowMinimumHeight(1,10);
        layout1->addWidget(lunedi,5,0);
        layout1->addWidget(text_Lun,5,1);
        layout1->addWidget(martedi,6,0);
        layout1->addWidget(text_Mar,6,1);
        layout1->addWidget(mercoledi,7,0);
        layout1->addWidget(text_Mer,7,1);
        layout1->addWidget(giovedi,8,0);
        layout1->addWidget(text_Gio,8,1);
        layout1->addWidget(venerdi,9,0);
        ...
        layout1->addWidget(p_mq,14,0);
        layout1->addWidget(text_P_Mq,14,1);
